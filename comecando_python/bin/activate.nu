...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/leonardo/Projetos/python/comecando_python'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/leonardo/Projetos/python/comecando_python/bin/deactivate.nu'
